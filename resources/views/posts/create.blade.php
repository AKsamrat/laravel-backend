<x-layout>
    ...
    <div class="p-4 sm:ml-64 mt-14">
        <div class="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
            ...
            <form method="POST" action="{{ isset($post) ? route('posts.edit.post', $post->id) : route('posts.create') }}"
                ...
                <textarea name="content" rows="5" class="w-full p-2 border rounded mb-4 " placeholder="Content">{{ old('content', $post->content ?? '') }}</textarea>
